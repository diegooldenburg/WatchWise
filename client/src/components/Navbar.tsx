  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-primary p-6">
      ...
      <div className="block lg:hidden">
        <button className="flex items-center px-3 py-2 border rounded text-secondary border-secondary hover:text-white hover:border-white">
          <svg
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        <div>
          ...
          <a
            href="#"
            className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-primary hover:bg-white mt-4 lg:mt-0 ml-2"
          >
            Log In
          </a>
        </div>
